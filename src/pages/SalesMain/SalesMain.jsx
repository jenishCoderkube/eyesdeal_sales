  ...
  return (
    <div className="mx-auto px-4">
      <img
        ...
        alt="Glasses Main"
        className="w-full h-[542px] object-cover rounded-lg mb-8 hidden md:block"
      />
      <div className="grid grid-cols-1 gap-y-[80px] md:grid-cols-2 lg:grid-cols-3 mx-auto justify-items-center md:mt-32 mt-16 md:max-w-[1400px]">
